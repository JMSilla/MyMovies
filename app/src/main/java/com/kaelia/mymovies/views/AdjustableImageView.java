package com.kaelia.mymovies.views;
...
public class AdjustableImageView extends ImageView {
    ...
    private boolean isInScrollingContainer() {
        //// FIXME: 27/09/15 implement with a XML parameter
        // shouldDelayChildPressedState() method is not available
        // in API 10 (minimum for this project)
